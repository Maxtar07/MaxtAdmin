...
module.exports = (localUserContextMenu, botUserContextMenu) => {
  const differences = {};
  if (localUserContextMenu.name !== botUserContextMenu.name) {
    differences.name = true;
  }
  //if (localUserContextMenu.description !== botUserContextMenu.description) {
  //  differences.description = true;
  //}
  const localOptions = localUserContextMenu.options || [];
  const botOptions = botUserContextMenu.options || [];
